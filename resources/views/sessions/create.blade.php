    ...
    <x-form-layout>
     ...
     <div class="flex justify-between mb-6 items-center">
         <div class="flex items-center gap-2">
             ...
             <label for="remember" class="w-[1.25rem] h-[1.25rem] border border-dark-60 rounded cursor-pointer flex items-center justify-center">
                 <x-svgs.check class="hidden"/>
             </label>
             <label for="remember" class="text-dark-100 text-[0.875rem] font-semibold cursor-pointer">Remember this device</label>
         </div>
