<svg {{ $attributes->merge(['class' => 'absolute top-1/2 -translate-y-1/2 right-5 hidden']) }} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
