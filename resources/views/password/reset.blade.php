<x-message-layout>
    ...
    <div class="w-[24.5rem] lg:mx-auto sm:w-[21.45rem] mx-auto flex flex-col items-center sm:flex-grow">
        <h1 class="text-dark-100 text-2xl font-extrabold mb-14 mt-36 sm:mt-11">{{__('reset.reset password')}}</h1>

        <div class="mb-14 w-full">
            <x-form.input name="password" placeholder="enter new password" label="new_password" type='password'/>
        ...
        <div class="w-full flex  sm:items-end sm:flex-grow">
            <x-form.button>{{__('reset.save changes')}}</x-form.button>
        </div>
